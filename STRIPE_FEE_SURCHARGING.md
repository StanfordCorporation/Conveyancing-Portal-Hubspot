...
After Stripe deducts A$2.09, you receive A$100.00
```
...
// result.grossAmountInCents = 10209 (A$102.09)
// result.stripeFeeInCents = 209 (A$2.09)
...
export const STRIPE_FEES = {
  DOMESTIC: {
    percentage: 0.0175,  // Update here
    fixed: 0.30,         // Update here
  },
  INTERNATIONAL: {
    percentage: 0.029,   // Update here
    fixed: 0.30,         // Update here
  },
};
```
