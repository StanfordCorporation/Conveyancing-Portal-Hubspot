...
const Index = () => {
  ...
  // Pre-fill email/mobile and message from disclosure form redirect
  useEffect(() => {
    if (location.state) {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      console.log(`📤 Sending OTP to ${loginMethod}: ${cleanIdentifier}`);
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      console.log(`🔐 Verifying OTP for ${loginMethod}: ${cleanIdentifier}`);
      ...
      // Redirect to dashboard with transition animation
      setTimeout(() => {
        ...
        try {
          ...
          // Fallback redirect using absolute path
  ...
  const features = [
    ...
    { icon: CheckCircle, title: "Easy Access", desc: "View updates anytime, anywhere" },
  ];
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 p-12">
          <div className="space-y-4 animate-fade-in">
            ...
            <h1 className="text-5xl font-bold text-foreground leading-tight">
              Welcome to Your
              <br />
              <span className="text-primary">Secure Portal</span>
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Access your information securely with our modern client portal
            </p>
          </div>
